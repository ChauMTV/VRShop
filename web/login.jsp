<%-- 
    Document   : login
    Created on : Jun 16, 2021, 12:44:54 AM
    Author     : WacMac
--%>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="panel panel-login">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-xs-6">
                                <a href="login.jsp" class="active" id="login-form-link">Đăng Nhập</a>
                            </div>
                            <div class="col-xs-6">
                                <a href="register.jsp" id="register-form-link">Đăng Ký</a>
                            </div>
                        </div>
                        <hr>
                    </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <form id="login-form" action="login" method="post" role="form" style="display: block;">
                                    <div class="form-group">
                                        <input type="text" name="user" id="username" tabindex="1" class="form-control" placeholder="Tài khoản" value="${cookie.user.value}">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="pass" id="password" tabindex="2" class="form-control" placeholder="Mật khẩu" value="${cookie.pass.value}">
                                    </div>
                                    <div class="form-group text-center">
                                        <input type="checkbox"${cookie.rem.value eq 'ON' ?"checked":""} value="ON" tabindex="3" class="" name="remember" id="remember">
                                         Remember Me
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                    ...
                    <div class="panel-body">
                        <form id="register-form" action="register" method="post" role="form" style="display: none;">
                            <div class="panel-body">
                                <div style="color:red" >${requestScope.error1}</div>
                                <div style="color:red" >${requestScope.error2}</div>
                                <div style="color:red" >${requestScope.error3}</div>	
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="password" name="re_pass" id="password" tabindex="2" class="form-control" placeholder="Mật khẩu">
                                </div>
                                <div class="row">
                                    <div class="col-sm-6 col-sm-offset-3">
